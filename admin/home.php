    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box "style="background-color: #f38e27;">
            <div class="inner">
              <?php
...
$(function(){
  ...
  barChartData.datasets[1].fillColor   = '#f38e27'
  barChartData.datasets[1].strokeColor = '#f38e27'
  barChartData.datasets[1].pointColor  = '#f38e27'
  var barChartOptions                  = {
